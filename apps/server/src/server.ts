...
import { handleExperimentsGet, handleExperimentsUpdate, handleReportsAdvice, handleSendGateAdvice } from "./routes/experiments.js";
...
async function dispatch(
  ...
  try {
    ...
    if (pathname === routes.sendGateAdvice && method === "POST") {
      await handleSendGateAdvice(ctx, req, res);
      return;
    }
