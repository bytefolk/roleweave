...
contextBridge.exposeInMainWorld("owb", {
  ...
  budgetRemainingAdvice: (request) => ipcRenderer.invoke("owb:turns:budget-advice", request),
  ...
  approvalAudit: (request) => ipcRenderer.invoke("owb:approvals:audit", request),
  ...
  positionDocs: (positionId, options) => ipcRenderer.invoke("owb:position:docs:list", positionId, options),
  positionDocFile: (positionId, filePath, options) => ipcRenderer.invoke("owb:position:docs:read", positionId, filePath, options),
  createPositionDoc: (request) => ipcRenderer.invoke("owb:position:docs:create", request),
  writePositionDoc: (request) => ipcRenderer.invoke("owb:position:docs:write", request),
  renamePositionDoc: (request) => ipcRenderer.invoke("owb:position:docs:rename", request),
  archivePositionDoc: (request) => ipcRenderer.invoke("owb:position:docs:archive", request),
  restorePositionDoc: (request) => ipcRenderer.invoke("owb:position:docs:restore", request),
  deletePositionDoc: (request) => ipcRenderer.invoke("owb:position:docs:delete", request),
