...
export interface OwbBridge {
  ...
  budgetRemainingAdvice?(request: import("@roleweave/shared").BudgetRemainingAdviceRequest): Promise<OwbApiResponse<import("@roleweave/shared").BudgetRemainingAdviceResponse>>;
