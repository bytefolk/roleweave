 ...
 */
export function OrgWorkspaceSplit({ ariaLabel, className, left, resetTitle, right, valueText }: OrgWorkspaceSplitProps) {
  ...
  return (
    <div
      ref={hostRef}
      className={`owb-org-module${className ? ` ${className}` : ""}`}
