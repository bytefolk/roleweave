 ...
 */
export function OrgWorkspaceSplit({ hidden = false, focused = false, ariaLabel, left, resetTitle, right, valueText }: OrgWorkspaceSplitProps) {
  ...
  return (
    <div
      ref={hostRef}
      hidden={hidden}
      className={`owb-org-module${focused ? " is-conversation-focused" : ""}`}
